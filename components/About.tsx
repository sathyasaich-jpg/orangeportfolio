      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
        <div className="lg:col-span-5 order-2 lg:order-1">
          <div className="relative paper-sheet p-3 bg-white dark:bg-zinc-900 shadow-2xl rotate-2">
            <img 
              src="https://images.unsplash.com/photo-1558478551-1a378f63ad28?auto=format&fit=crop&q=80&w=1000" 
              alt="Design Process" 
        ...
        <div className="lg:col-span-7 space-y-6 lg:pl-10 order-1 lg:order-2">
          ...
          <div className="bg-white/50 dark:bg-zinc-900/50 p-6 md:p-8 paper-sheet border-t-8 border-brand-orange -rotate-1">
            <p className="text-lg md:text-xl font-light leading-snug opacity-90 text-zinc-800 dark:text-zinc-200">
              Sathya is a multi-disciplinary designer currently based in Bangalore. Her practice is rooted in the belief that design should be <span className="italic font-serif font-black text-brand-red">felt</span> as much as it is seen.
            </p>
            <p className="mt-4 text-lg font-light leading-snug opacity-80 text-zinc-800 dark:text-zinc-200">
              Bridging complexity and clarity through narrative-driven design thinking. Specializing in visual metaphors and tactile digital experiences.
            </p>
          </div>
